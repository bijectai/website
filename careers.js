...
const FALLBACK_ROLES = [
  {
    ...
    about: "biject builds custom, formally verified regulation-check platforms for regulated organizations — hand-written Lean 4 specifications that turn rules and internal policy into machine-checked, mathematical proof. Financial compliance (SEC, FINRA, CFPB) was our proving ground, and it's where this role starts; the broader mission is general regtech, and every kernel we write compounds into the foundational dataset the field is missing. We're looking for a sharp pre-law or finance undergraduate with deep fluency in financial regulation to help build that dataset.\nThis is a ground-floor research role at the intersection of law, formal logic, and machine learning. You won't be coding. You'll be doing something harder: translating ambiguous, clause-dense regulatory language into structured, machine-readable knowledge that a theorem prover can reason over.",
    responsibilities: [
